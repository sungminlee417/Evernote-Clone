...
const Header = () => {
  ...
  return (
    <div
      className={`fixed w-full flex justify-between items-center tracking-wide bg-white transition-all duration-200 lg:px-24 md:px-12 p-8 ${
        scroll ? "shadow-md" : ""
      }`}
    >
      <button
      ...
      >
        <i className="fa-brands fa-evernote text-[#00a82d] text-7xl"></i>
        <strong className="tracking-wide text-4xl md:block hidden">
          Betternote
        </strong>
      </button>
      <div className="flex items-center gap-4">
        <a
          href="https://github.com/sungminlee417/Evernote-Clone.git"
